...
(function(f) {
  ...
  return function e(t, n, r) {
    ...
    var a = arguments;
  	trace("ppt, args length:" + a.length);
	trace("ppt, arguments:" + a);
	trace("ppt, require:" + require);
	trace("ppt, module:" + module);
	trace("ppt, exports:" + exports);
    (function(global) {
      var adapterFactory = require("./adapter_factory.js");
	  trace("ppt, adapterFactory:" + adapterFactory);
...
var Analytics = function(roomServer) {
  trace("ppt, Analytics, roomServer:" + roomServer);
...
Call.prototype.maybeCreatePcClientAsync_ = function() {
  return new Promise(function(resolve, reject) {
    ...
    if (typeof RTCPeerConnection.generateCertificate === "function") {
	  trace("ppt, in maybeCreatePcClientAsync_, generateCertificate is function");
	  ...
	  trace("ppt, in maybeCreatePcClientAsync_, generateCertificate is not function");
      this.createPcClient_();
      resolve();
    }
  }.bind(this));
...
PeerConnectionClient.prototype.receiveSignalingMessage = function(message) {
  trace("ppt, in receiveSignalingMessage, message:" + message);
...
SignalingChannel.prototype.open = function() {
  ...
  return new Promise(function(resolve, reject) {
    if (isChromeApp()) {
      ...
      trace("ppt, in SignalingChannel.prototype.open, wssUrl_: " + this.wssUrl_)
