...
ICE_SERVER_OVERRIDE  = [
  {
    "urls": [
      "turn:192.168.9.149?transport=udp",
      "turn:192.168.9.149?transport=tcp"
    ],
    "username": "inesadt",
#    "credential": "inesadt"
    "credential": "0xe01527538ba974fd6499eaee1c40e1a2"
  },
  {
    "urls": [
      "stun:192.168.9.149"
...
#   }
# ]
TURN_BASE_URL = 'http://192.168.9.149:9998'
#TURN_URL_TEMPLATE = '%s/turn.php?username=%s&key=%s'
#CEOD_KEY = 'inesadt' #必须和cotrun服务器配置一致
#ICE_SERVER_BASE_URL = 'https://networktraversal.googleapis.com'
ICE_SERVER_BASE_URL = 'http://192.168.9.149:9998'
#ICE_SERVER_URL_TEMPLATE = '%s/v1alpha/iceconfig.php#?key=%s'
ICE_SERVER_URL_TEMPLATE = '%s/iceconfig.php?key=%s'
#ICE_SERVER_API_KEY = os.environ.get('ICE_SERVER_API_KEY')
#ICE_SERVER_API_KEY = '0xe01527538ba974fd6499eaee1c40e1a2'
ICE_SERVER_API_KEY = 'inesadt'

# Dictionary keys in the collider instance info constant.
#WSS_INSTANCE_HOST_KEY = 'host_port_pair'
WSS_INSTANCE_HOST_KEY = '192.168.9.149:8089'
