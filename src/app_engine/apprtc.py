...
def make_pc_config(ice_transports, ice_server_override):
  config = {
  #'iceServers': [{"urls":"stun:192.168.9.149"},{"urls":"turn:192.168.9.149","username":"inesadt","credential":"0xe01527538ba974fd6499eaee1c40e1a2"}],
  'iceServers': [{"urls":"stun:192.168.9.149"},{"urls":"turn:192.168.9.149","username":"inesadt","credential":"inesadt"}],
  #'iceServers': [{"urls":"stun:192.168.9.149"},{"urls":"turn:192.168.9.149","username":"inesadt","credential":"inesadt"}],
  #'iceServers': [{"urls":"stun:192.168.9.149"},{"urls":"turn:192.168.9.149","username":"inesadt","password":"inesadt"}],
  #'iceServers': [{"urls":"stun:192.168.9.149"},{"urls":"turn:inesadt@192.168.9.149","credential": "inesadt"}],
  #'iceServers': [],
